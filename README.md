...
[![Automatic tests level](https://apps.yunohost.org/badge/cilevel/mostlymatter)](https://ci-apps.yunohost.org/ci/apps/mostlymatter/)

🛠️ Upstream Mostlymatter repository: <https://framagit.org/framasoft/framateam/mostlymatter>

Pull request are welcome and should target the [`testing` branch](https://github.com/YunoHost-Apps/mostlymatter_ynh/tree/testing).

The `testing` branch can be tested using:
```
# fresh install:
sudo yunohost app install https://github.com/YunoHost-Apps/mostlymatter_ynh/tree/testing

# upgrade an existing install:
sudo yunohost app upgrade mostlymatter -u https://github.com/YunoHost-Apps/mostlymatter_ynh/tree/testing
```
